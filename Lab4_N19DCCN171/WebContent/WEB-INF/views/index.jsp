    ...
    <body data-bs-spy="scroll" data-bs-target="#navbarExample">
        ...
        <nav id="navbarExample" class="navbar navbar-expand-lg fixed-top navbar-light" aria-label="Main navigation">
            <div class="container">
                ...
                <!-- Image Logo -->
                <a class="navbar-brand logo-image" href="index.htm"><img src="${pageContext.request.contextPath}/resources/homapage/images/logo.png" alt="alternative"></a> 

                <!-- Text Logo - Use this if you don't have a graphic logo -->
                <!-- <a class="navbar-brand logo-text" href="index.htm">Ioniq</a> -->
                ...
                <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
                    ...
                    <span class="nav-item">
                        <a class="btn-outline-sm" href="log-in.htm">Log in</a>
                    </span>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="text-container">
                            ...
                            <a class="btn-solid-lg" href="sign-up.htm">Become a member now</a>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-xl-7">
                        <div class="image-container">
                            <img class="img-fluid" src="${pageContext.request.contextPath}/resources/homapage/images/details-1.svg" alt="alternative">
                        </div> <!-- end of image-container -->
                    </div> <!-- end of col -->
                </div> <!-- end of row -->
            </div> <!-- end of container -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div class="image-container">
                                <img class="img-fluid" src="${pageContext.request.contextPath}/resources/homapage/images/details-modal.jpg" alt="alternative">
                            </div> <!-- end of image-container -->
                        </div> <!-- end of col -->
                        <div class="col-lg-4">
                            <h3>Goals Setting</h3>
        ...
        <div class="basic-2">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="image-container">
                            <img class="img-fluid" src="${pageContext.request.contextPath}/resources/homapage/images/details-2.png" alt="alternative">
                        </div> <!-- end of image-container -->
                    </div> <!-- end of col -->
                    <div class="col-lg-6">
                        <div class="text-container">
                            ...
                            <div class="swiper-container card-slider">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card">
                                            <img class="card-image" src="${pageContext.request.contextPath}/resources/homapage/images/testimonial-1.jpg" alt="alternative">
                                            <div class="card-body">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card">
                                            <img class="card-image" src="${pageContext.request.contextPath}/resources/homapage/images/testimonial-2.jpg" alt="alternative">
                                            <div class="card-body">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card">
                                            <img class="card-image" src="${pageContext.request.contextPath}/resources/homapage/images/testimonial-3.jpg" alt="alternative">
                                            <div class="card-body">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card">
                                            <img class="card-image" src="${pageContext.request.contextPath}/resources/homapage/images/testimonial-4.jpg" alt="alternative">
                                            <div class="card-body">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card">
                                            <img class="card-image" src="${pageContext.request.contextPath}/resources/homapage/images/testimonial-5.jpg" alt="alternative">
                                            <div class="card-body">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card">
                                            <img class="card-image" src="${pageContext.request.contextPath}/resources/homapage/images/testimonial-6.jpg" alt="alternative">
                                            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="card-title">
                                    <img class="decoration-lines" src="${pageContext.request.contextPath}/resources/homapage/images/decoration-lines.svg" alt="alternative"><span>Professional</span><img class="decoration-lines flipped" src="images/decoration-lines.svg" alt="alternative">
                                </div>
                                <ul class="list-unstyled li-space-lg">
        ...
        <!-- Scripts -->
        <script src="${pageContext.request.contextPath}/resources/homapage/js/bootstrap.min.js"></script> <!-- Bootstrap framework -->
        <script src="${pageContext.request.contextPath}/resources/homapage/js/swiper.min.js"></script> <!-- Swiper for image and text sliders -->
        <script src="${pageContext.request.contextPath}/resources/homapage/js/purecounter.min.js"></script> <!-- Purecounter counter for statistics numbers -->
        <script src="${pageContext.request.contextPath}/resources/homapage/js/replaceme.min.js"></script> <!-- ReplaceMe for rotating text -->
        <script src="${pageContext.request.contextPath}/resources/homapage/js/scripts.js"></script> <!-- Custom scripts -->
    </body>
</html>